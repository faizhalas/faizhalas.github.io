    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-we-had-the-opportunity-to-present-our-project-at-the-asis-amp-amp-t-annual-meeting-2026-in-bangkok",
          title: 'We had the opportunity to present our project at the ASIS&amp;amp;amp;T Annual Meeting...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%66%61%69%7A%68%61%6C%61%72%69%66@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/faizhalas", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/faizhalas", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-2788-9463", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=5eVqmcgAAAAJ", "_blank");
        },
      },{
        id: 'social-scopus',
        title: 'Scopus',
